...
\begin{figure}[H]
    \centering
     \includegraphics[height=12.5cm]{../Figures/power_system/power_system.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{.4\textwidth}
        \centering
        \includegraphics[height=4.0cm]{../Figures/drone/drone_front.jpg}
        \caption{}
        \label{fig:drone_front}
    \end{subfigure}
    \begin{subfigure}[b]{.4\textwidth}
        \centering
        \includegraphics[height=4.0cm]{../Figures/drone/drone_front2.jpg}
        \caption{}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{.22\textwidth}
        \centering
        \includegraphics[height=4.0cm]{../Figures/drone/drone_close1.jpg}
        \caption{}
        \label{fig:drone_close_one}
    \end{subfigure}
    \begin{subfigure}[b]{.22\textwidth}
        \centering
        \includegraphics[height=4.0cm]{../Figures/drone/drone_close2.jpg}
        \caption{}
        \label{fig:drone_close_two}
    \end{subfigure}
    \begin{subfigure}[b]{.22\textwidth}
        \centering
        \includegraphics[height=4.0cm]{../Figures/drone/drone_bottom.jpg}
        \caption{}
        \label{fig:drone_bottom}
    \end{subfigure}
    \begin{subfigure}[b]{.22\textwidth}
        \centering
        \includegraphics[height=4.0cm]{../Figures/drone/drone_bottom_zoom.jpg}
        \caption{}
        \label{fig:drone_bottom_zoom}
    \end{subfigure}
