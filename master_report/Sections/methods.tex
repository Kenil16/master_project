...
\tikzstyle{mybox} = [draw=white, fill=white!20, very thick,
...
\node [mybox] (box){%
    \begin{minipage}{0.90\textwidth}
     {\small\
        ...
        \begin{fleqn}
        \begin{align}
        	X_i = \bar{x} + \left(\sqrt{(L+\lambda})\textbf{P}_x\right)_i \qquad i=1,...,L
        \end{align}
        \end{fleqn}
        
        \begin{fleqn}
        \begin{align}
        	X_i = \bar{x} - \left(\sqrt{(L+\lambda})\textbf{P}_x\right)_{i-L} \qquad i=L,...,2L
        \end{align}
        \end{fleqn}
        ...
        \begin{fleqn}
        \begin{align}
        	W^{(m)}_i = W^{(c)}_i = \frac{1}{2(L+\lambda)} \qquad i=1,...,2L
        \end{align}
        \end{fleqn}
...
\vspace{-4.0em}
		\end{tikzpicture}%
		\caption{Calculating sigma points and weights} \label{fig:calculating_sigma_points_and_weights}
    \end{subfigure}
        \begin{subfigure}[t]{.40\textwidth}
        \includegraphics[height=6.0cm]{../Figures/ukf.png}
		\caption{Initialization} \label{fig:M1}
    \end{subfigure}
    \caption{Initialization} \label{fig:M1}
\end{figure}
...
\node [mybox] (box){%
    ...
    {\small\
        ...
        \begin{fleqn}
        \begin{align}
            \mathcal{X}^{x}_{k | k-1} = \textbf{F}[\mathcal{X}^{x}_{k-1}, \textit{\textbf{X}}^{v}_{k-1}]  
        \end{align}
        \end{fleqn}
    ...
    \end{minipage}
		...
		\end{tikzpicture}%
		\caption{Prediction update} \label{fig:M1}
    \end{subfigure}
            \begin{subfigure}[t]{.48\textwidth}
        \centering
		\begin{tikzpicture}
\node [mybox] (box){%
    ...
    {\small\
        \begin{fleqn}
        \begin{align}
            \textit{\textbf{X}}^{x}_{k | k-1} = \textbf{F}[\textit{\textbf{X}}^{x}_{k-1}, \textit{\textbf{X}}^{v}_{k-1}]  
        \end{align}
        \end{fleqn}
     }
    \end{minipage}
		...
		\end{tikzpicture}%
		\caption{easurement update} \label{fig:M1}
    \end{subfigure}
    \caption{Initialization} \label{fig:M1}
\end{figure}
