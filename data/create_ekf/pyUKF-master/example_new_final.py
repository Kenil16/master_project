...
class ukf():
    ...
    def main(self):
        ...
        r_imu_acc[0][0] = self.covariance[12]
        r_imu_acc[1][1] = self.covariance[13]
        r_imu_acc[2][2] = self.covariance[14]
        r_imu_gyro_v[0][0] = self.covariance[15]
        r_imu_gyro_v[1][1] = self.covariance[16]
        r_imu_gyro_v[2][2] = self.covariance[17]
        
        r_vision_pos = np.zeros([3, 3])
        r_vision_ori = np.zeros([3, 3])
        r_vision_pos[0][0] = self.covariance[18]
        r_vision_pos[1][1] = self.covariance[19]
        r_vision_pos[2][2] = self.covariance[20]
        r_vision_ori[0][0] = self.covariance[21]
