    ...
    def read_dir_files(self, path):
        ...
        for fle in files:
            ...
            self.plot_data([aruco_roll, setpoint_roll, g_roll], 'Time [s]', 'Time [s]', 'Angle [degress]', 
                'Error [m]', 'Error in angle and setpoint deviation in roll', [['Aruco angle roll'],['Setpoint roll'],['Ground truth roll']], 
            ...
            self.plot_data([aruco_pitch, setpoint_pitch, g_pitch], 'Time [s]', 'Time [s]', 'Angle [degress]', 
                    'Error [m]', 'Error in angle and setpoint deviation in pitch', [['Aruco angle pitch'],['Setpoint pitch'],['Ground truth pitch']], 
            ...
            self.plot_data([aruco_yaw, setpoint_yaw, g_yaw], 'Time [s]', 'Time [s]', 'Angle [degress]', 
                    'Error [m]', 'Error in angle and setpoint deviation in yaw', [['Aruco angle yaw'],['Setpoint yaw'],['Ground truth yaw']], 
