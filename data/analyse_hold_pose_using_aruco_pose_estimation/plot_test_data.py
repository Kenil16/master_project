...
class plot_data():
    ...
    def __init__(self):
        ...
        self.data = []
        dir_ = 'test5_landingBoard3_noWind/'
    ...
    def read_dir_files(self, path):
        ...
        for fle in files:
            ...
            self.plot_data([aruco_x, setpoint_x, g_x], 'Time [s]', 'Time [s]', 'Position [m]', 
                'Error [m]', 'Error in position and setpoint deviation in x for test ' + str(test), [['Aruco pos x'],['Setpoint x'],['Ground truth x']], 
            ...
            self.plot_data([aruco_y, setpoint_y, g_y], 'Time [s]', 'Time [s]', 'Position [m]', 
                'Error [m]', 'Error in position and setpoint deviation in y test ' + str(test), [['Aruco pos y'],['Setpoint y'],['Ground truth y']], 
            ...
            self.plot_data([aruco_z, setpoint_z, g_z], 'Time [s]', 'Time [s]', 'Position [m]', 
                'Error [m]', 'Error in position and setpoint deviation in z test ' + str(test), [['Aruco pos z'],['Setpoint z'],['Ground truth z']], 
            ...
            self.plot_data([aruco_roll, setpoint_roll, g_roll], 'Time [s]', 'Time [s]', 'Angle [degress]', 
                'Error [m]', 'Error in angle and setpoint deviation in roll test ' + str(test), [['Aruco angle roll'],['Setpoint roll'],['Ground truth roll']], 
            ...
            self.plot_data([aruco_pitch, setpoint_pitch, g_pitch], 'Time [s]', 'Time [s]', 'Angle [degress]', 
                    'Error [m]', 'Error in angle and setpoint deviation in pitch test ' + str(test), [['Aruco angle pitch'],['Setpoint pitch'],['Ground truth pitch']], 
            ...
            self.plot_data([aruco_yaw, setpoint_yaw, g_yaw], 'Time [s]', 'Time [s]', 'Angle [degress]', 
                    'Error [m]', 'Error in angle and setpoint deviation in yaw test ' + str(test), [['Aruco angle yaw'],['Setpoint yaw'],['Ground truth yaw']], 
