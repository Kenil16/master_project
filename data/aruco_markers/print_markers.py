...
class print_markers:
    ...
    def __init__(self):
        ...
        self.marker_separation = 75.590551181 #Approx 0.02 meters in pixels 
        self.aruco_board = cv2.board = aruco.GridBoard_create(self.markers_x, self.markers_y, self.marker_length, self.marker_separation, self.dictionary)
