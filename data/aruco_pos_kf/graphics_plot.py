...
if __name__ == "__main__":
    ...
    gp.plot_kf_data('data.txt','Estimated ArUco marker position','Time [s]', 'x [m]','kf_pos_x.png',0,3,6)
    gp.plot_kf_data('data.txt','Estimated ArUco marker position','Time [s]', 'y [m]','kf_pos_y.png',1,4,6)
    gp.plot_kf_data('data.txt','Estimated ArUco marker position','Time [s]', 'z [m]','kf_pos_z.png',2,5,6)
