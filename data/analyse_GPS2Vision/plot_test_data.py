...
class plot_data():
    ...
    def plot_data(self, path):
        ...
        ax.annotate('Start from GPS', xy=(3,0.5), xytext=(2.55,-18), size=25,bbox=dict(boxstyle="round, pad=0.3",fc="white", ec="k", lw=1))
        ...
        print("GPD travel time: " + "{:.4f}".format(sum(self.gps_time)/len(self.gps_time)))
