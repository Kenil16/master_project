...
if __name__ == "__main__":
    gp = graphics_plot()
    gp.plot_data('data.txt','Setpoint vs estimated ArUco marker position','Time [s]', 'x [m]','error_x.png',0,1,6)
    gp.plot_data('data.txt','Setpoint vs estimated ArUco marker position','Time [s]', 'y [m]','error_y.png',2,3,6)
    gp.plot_data('data.txt','Setpoint vs estimated ArUco marker position','Time [s]', 'z [m]','error_z.png',4,5,6)
