...
class log_data():
    ...
    def write_vision_imu_data(self, x, y, z, acc_x, acc_y, acc_z, roll, pitch, 
                              yaw, gyro_x, gyro_y, gyro_z, baro, time_imu, vision_seq, 
                              imu_seq, baro_seq, g_roll, g_pitch, g_yaw, g_x, g_y, g_z, time_vision):
        ...
        data.write(str(x) + " " + str(y) + " " + \
                   ...
                   str(baro) + " " + str(time_imu) + " " + str(vision_seq) + " " + \
                   str(imu_seq) + " " + str(baro_seq) + " " + str(g_roll) + " " + \
                   str(g_pitch) + " " + str(g_yaw) + " " + str(g_x) + " " + str(g_y) + " " + str(g_z) + " " + str(time_vision))
        data.write('\n')
        data.close()
